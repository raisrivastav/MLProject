...
# ensure the top‑level package is on sys.path when running as a script
# (alternatively install the package with setup.py or invoke with -m)
...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        ...
        try:
            df = pd.read_csv(os.path.join(PACKAGE_ROOT, 'notebook', 'data', 'stud.csv'))
